...
<br>
 ...
 <details><summary><font size="6"><b>6)  Host removal</b></font></summary>
  ...
  <br>
  To remove the host sequences we must first align our reads to the host genome. To do this we will use [BWA](https://bio-bwa.sourceforge.net) to align our trimmed sequences to our reference genome.
